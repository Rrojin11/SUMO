...
class qlEnv():
    def __init__(self, sumoBinary, net_file: str,det_file: str, cfg_file: str, alldets: list, edgelists: list, dict_connection, veh:str, use_gui: bool = True,
