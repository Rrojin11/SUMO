...
class dqnEnv():
    def __init__(self, sumoBinary, net_file: str, cfg_file: str, edgelists: list,alldets: list, dict_connection, veh:str, endpoint: list, destination:str, state_size: int, action_size: int, use_gui: bool = True,
